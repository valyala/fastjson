...
func testArena(a *Arena) error {
	...
	o.Set("nb", a.NewNumberBytes([]byte("12.12")))
	s := a.NewString("foo")
	o.Set("str1", s)
	...
	str := o.String()
	strExpected := `{"nil1":null,"nil2":null,"false":false,"true":true,"ni":123,"nf":1.23,"ns":34.43,"nb":12.12,"str1":"foo","str2":"xx","a":["foo",123],"obj":{"s":"foo"}}`
	if str != strExpected {
